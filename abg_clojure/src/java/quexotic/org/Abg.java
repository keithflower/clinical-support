...
public class Abg {
    ...
    private static boolean acidemia (double pH) {
        return (pH < 7.40 ? true : false);
    }

    private static boolean low_paCO2 (double paCO2) {
        return ( paCO2 < 40 ? true : false);
    }

    private static boolean high_paCO2 (double paCO2) {
        return ( paCO2 > 44 ? true : false);
    }

    private static boolean normal_paCO2 (double paCO2) {
